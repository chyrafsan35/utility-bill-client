...
const Login = () => {
    ...
    const DEMO_EMAIL = "rafsan@chy.com";
    const DEMO_PASSWORD = "RafsanPassCC35";
    ...
    return (
        <div className="flex flex-col justify-center items-center py-15">
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-sm">
                <div>
                    <form className="card-body" action="" onSubmit={handleLogin}>
                        <fieldset className="fieldset">
                            <label className="label">Email</label>
                            <input ref={emailRef} type="email" className="input" name='email' />

                            <label className="label">Password</label>
                            <input ref={passwordRef} type="password" className="input" name='password' />
